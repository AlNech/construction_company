...
@section('content')
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.services.index') }}" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
                Назад к списку
            </a>
        </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @if($service->image)
                            <img src="{{ $service->image  }}" alt="Изображение услуги" class="w-full h-auto rounded-lg shadow">
                        @else
                ...
                <div class="mt-6 flex justify-end">
                    <a href="{{ route('admin.services.edit', $service) }}" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
                        Редактировать
                    </a>
                </div>
            </div>
