                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" id="feedbackForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone"
                                   ...
                                   pattern="[\+]\d{1,3}\s?[(]{0,1}\d{1,4}[)]{0,1}\s?\d{1,4}[\-]\d{1,4}[\-]\d{1,4}">
                            @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
    ...
    <section class="map-section">
        <div class="container">
            <div class="map-container">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2245.373789929732!2d37.61842331593095!3d55.75369628055314!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b54a5a738fa419%3A0x7c347d506f52311a!2z0JrRgNCw0YHQvdCw0Y8g0YPQuy4sIDE1LCDQnNC-0YHQutCy0LAsIDEyMzAyMg!5e0!3m2!1sru!2sru!4v1686754326784!5m2!1sru!2sru"
