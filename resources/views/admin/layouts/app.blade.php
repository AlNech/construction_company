    ...
    <div class="bg-indigo-600 pb-32">
        <div class="py-4 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <div class="md:hidden">
                    <button type="button" class="text-white hover:text-indigo-200 focus:outline-none"
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <nav class="space-y-1 p-4">
                            ...
                            <a href="{{ route('admin.dashboard') }}"
                               class="@if(request()->routeIs('admin.dashboard')) bg-indigo-50 text-indigo-700 @else text-gray-600 hover:bg-gray-50 @endif group flex items-center px-3 py-2 text-sm font-medium rounded-md">
                            ...
                            <a href="{{ route('admin.services.index') }}"
                               class="@if(request()->routeIs('admin.services.*')) bg-indigo-50 text-indigo-700 @else text-gray-600 hover:bg-gray-50 @endif group flex items-center px-3 py-2 text-sm font-medium rounded-md">
                            ...
                            <a href="{{ route('admin.portfolio.index') }}"
                               class="@if(request()->routeIs('admin.portfolio.*')) bg-indigo-50 text-indigo-700 @else text-gray-600 hover:bg-gray-50 @endif group flex items-center px-3 py-2 text-sm font-medium rounded-md">
                            ...
                            <a href="{{ route('admin.news.index') }}"
                               class="@if(request()->routeIs('admin.news.*')) bg-indigo-50 text-indigo-700 @else text-gray-600 hover:bg-gray-50 @endif group flex items-center px-3 py-2 text-sm font-medium rounded-md">
                            ...
                            <a href="{{ route('admin.applications.index') }}"
                               class="@if(request()->routeIs('admin.applications.*')) bg-indigo-50 text-indigo-700 @else text-gray-600 hover:bg-gray-50 @endif group flex items-center px-3 py-2 text-sm font-medium rounded-md">
        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="mt-5 px-2 space-y-1">
                    ...
                    <a href="{{ route('admin.dashboard') }}"
                       class="@if(request()->routeIs('admin.dashboard')) bg-indigo-50 text-indigo-700 @else text-gray-600 hover:bg-gray-50 @endif group flex items-center px-2 py-2 text-base font-medium rounded-md">
